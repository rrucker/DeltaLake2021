 ...
 * file...
 *  2020-10-10/18 __ 2021-10-19__ rr
...
import cats.data          // a strictly functional library based n ategory theory
...
println(s" using a 'var' --baaad--to write out a range(0,5).toDF(nr) to the path as a delta file ,I made the col = nr  ")
...
val deltaTable = DeltaTable.forPath(path)  // DeltaTable is key delta-lakes object
